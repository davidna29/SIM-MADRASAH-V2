<x-layouts.page
    ...
    <div class="mx-auto max-w-3xl">
        <div class="flex flex-wrap items-end justify-between gap-4">
            <div>
                <h1 class="text-2xl font-extrabold tracking-tight text-ink sm:text-3xl">Rapor Saya</h1>
                <p class="mt-1.5 max-w-prose text-sm leading-relaxed text-ink-soft">
                    Rapor yang diterbitkan madrasah untuk tahun ajaran berjalan.
                </p>
            </div>
            <x-ui.button variant="primary" icon="arrow-down-tray" href="{{ route('siswa.rapor.unduh') }}">Unduh PDF</x-ui.button>
        </div>
